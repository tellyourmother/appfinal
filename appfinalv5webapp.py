...
st.title("🏀 NBA Player Stat Predictor (Upgraded Manual Opponent)")
...
if player_name:
    with st.spinner("Loading and predicting..."):
        ...
        # NEW: Manual opponent input
        next_opponent = st.text_input("Enter next opponent team abbreviation (e.g., LAL, MIL, BOS):").upper()
        if next_opponent:
